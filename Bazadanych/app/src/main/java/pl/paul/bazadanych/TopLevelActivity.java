...
public class TopLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            db = filmDatabaseHelper.getReadableDatabase();
            favoritesCursor = db.query("FILM",
        ...
        listFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View v, int position, long id) {
                Intent intent = new Intent(TopLevelActivity.this, FilmActivity.class);
    ...
    public void onRestart() {
        ...
        try {
            ...
            FilmDatabaseHelper filmsDatabaseHelper = new FilmDatabaseHelper(this);
            db = filmsDatabaseHelper.getReadableDatabase();
            Cursor newCursor = db.query("FILM",
                    new String[]{"_id", "NAME"},
                    "FAVORITE = 1",
                    null, null, null, null);
